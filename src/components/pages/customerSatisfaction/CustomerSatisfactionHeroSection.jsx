// src/components/pages/customerSatisfaction/CustomerSatisfactionHeroSection.jsx
...
const TAG_ICONS = [<HandshakeIcon />, <LanguageIcon />, <BarChartIcon />];

const CustomerSatisfactionHeroSection = () => {
  const theme = useTheme();
  const isDark = theme.palette.mode === "dark";
  const { t } = useTranslation("customer_satisfaction");

  const tagsRaw = t("hero.chips", { returnObjects: true });
...
export default CustomerSatisfactionHeroSection;
